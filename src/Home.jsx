    ...
    <>
      <div className="min-h-screen flex flex-col items-center">
        ...
        <div className="w-full font-bold">
          <div
            className="rounded-tl-[40px] rounded-tr-[40px] p-8 sm:p-8 shadow-xl"
            style={{
              background: "linear-gradient(180deg, #89C6A7 0%, #25596E 100%)",
            }}
          >
            <Link to="/register">
              <button className="w-full shadow-xl bg-white text-linear-gradient(180deg, #89C6A7 0%, #25596E 50%) py-3 sm:py-3 text-base sm:text-lg rounded-full mb-6 sm:mb-8 transition">
                Sign Up
              </button>
            </Link>
